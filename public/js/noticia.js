    ...
    `
      ...
      <div class="glass-panel p-4 rounded-4 text-center mb-4" style="border: 1px solid var(--line); background: var(--surface-muted);">
          ...
          <div class="d-flex justify-content-center gap-2 flex-wrap">
              ...
              <button onclick="loginSocialComentario('twitter')" class="btn btn-dark rounded-pill px-4 shadow-sm fw-bold small"><svg width="16" height="16" fill="currentColor" class="me-2" viewBox="0 0 16 16"><path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865l8.875 11.633Z"/></svg> X (Twitter)</button>
              <button onclick="loginSocialComentario('twitch')" class="btn rounded-pill px-4 shadow-sm fw-bold small" style="background-color: #9146FF; color: white; border: none;"><svg width="16" height="16" fill="currentColor" class="me-2" viewBox="0 0 16 16"><path d="M3.857 0 1 2.857v10.286h3.429V16l2.857-2.857H9.57L14.714 8V0H3.857zm9.714 7.429-2.285 2.285H9l-2 2v-2H4.429V1.143h9.142v6.286z"/><path d="M11.857 3.143h-1.143V6.57h1.143V3.143zm-3.143 0H7.571V6.57h1.143V3.143z"/></svg> Twitch</button>
              <button onclick="loginSocialComentario('apple')" class="btn btn-dark rounded-pill px-4 shadow-sm fw-bold small"><svg width="16" height="16" fill="currentColor" class="me-2" viewBox="0 0 16 16"><path d="M11.182.008C11.148-.03 9.923.023 8.857 1.18c-1.066 1.156-.902 2.482-.878 2.516.024.034 1.52.087 2.475-1.258.955-1.345.762-2.391.728-2.43Zm3.314 11.733c-.048-.096-2.325-1.234-2.113-3.422.212-2.189 1.675-2.789 1.698-2.854.023-.065-.597-.79-1.254-1.157a3.692 3.692 0 0 0-1.563-.434c-1.08-.04-2.004.575-2.475.575-.47 0-1.404-.504-2.265-.523-1.006-.024-1.921.434-2.428 1.137-1.157 1.597-2.204 4.542-1.077 6.467.542.929 1.183 1.956 2.193 1.922 1.009-.033 1.342-.647 2.548-.647 1.206 0 1.517.614 2.569.647 1.05.034 1.603-.993 2.146-1.922.544-.929.765-1.83.765-1.874Z"/></svg> Apple</button>
          </div>
      </div>
    `;
